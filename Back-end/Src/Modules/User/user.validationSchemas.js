...
export const createUserSchema = Joi.object({
  ...
  profile_pic: Joi.string().optional().allow(null).messages({
  ...
  installed_products: Joi.array().items(
    Joi.object({
      ...
      installation_location: Joi.string().required().messages({
...
export const updateUserSchema = Joi.object({
  ...
  installed_products: Joi.array().items(
    Joi.object({
      ...
      installation_location: Joi.string().optional().messages({
        'string.base': 'Installation location should be a type of text',
        'string.empty': 'Installation location cannot be an empty field'
      }),
